            ...
            while (iterator.hasNext()) {
               ...
               try {
                   ...
                   if (quote.getVolume() != null) {
                       volume = quote.getVolume().intValue();
                   }
                   int avgvolume = 0;
                   if (quote.getAvgVolume() != null) {
                       avgvolume = quote.getAvgVolume().intValue();
                   }
                   float mktcap = 0;
                   if (stats.getMarketCap() != null) {
                       mktcap = stats.getMarketCap().floatValue();
                   }
                   float eps = 0;
                   ...
                   quoteCV.put(Contract.Quote.COLUMN_MKTCAP, mktcap);
                   ...
                   Timber.e("Error querying data for: " + symbol + " : " +  e.getMessage());
                }
            }
